...
public:
  ...
  linear_elasticity(double lambda, double mu, double emat1, double numat1, double emat2, double numat2, bool SUPERVISED_LEARNING, int MAX_EPOCH, 
      ...
      : Base(std::forward<std::vector<int64_t>>(layers),
        ...
        lambda_(lambda), mu_(mu), emat1_(emat1), numat1_(numat1), emat2_(emat2), numat2_(numat2), SUPERVISED_LEARNING_(SUPERVISED_LEARNING), MAX_EPOCH_(MAX_EPOCH), 
...
int main() {
    ...
    // calculation of lame parameters i think we nee E und nu for the gismo vgl thingy to have some physics info.
